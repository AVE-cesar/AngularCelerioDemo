 ...
 * Template angular-lab:springboot/src/test/java/rest/BookResourceUnitTest.p.vm.java
 */
package com.jaxio.demo.rest;
...
public class BookResourceUnitTest {
    ...
    public void init() {
        MockitoAnnotations.initMocks(this);
        mockMvc = MockMvcBuilders.standaloneSetup(bookResource).addFilters(new CorsFilter())
        /* to handle Pageable automatically */
    ...
    public void testCreate() {
        ...
        try {
            ...
            mockMvc.perform(put("/api/books/").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
            /* add a request parameter */
            .content(JsonUtils.convertObjectToJsonBytes(book))).andExpect(status().isOk())
            /* tp print the PUT result */
            .andDo(print())
            // to validate json result content
                    .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)).andExpect(jsonPath(".price", nullValue()));
    ...
    public void testUpdate() {
        ...
        try {
            ...
            mockMvc.perform(put("/api/books/").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE).content(JsonUtils.convertObjectToJsonBytes(book)))
                    .andExpect(status().isOk())
                    /* tp print the PUT result */
                    .andDo(print())
                    // to validate json result content
    ...
    public void testFindAll() {
        ...
        try {
            ...
            mockMvc.perform(get("/api/books/")).andExpect(status().isOk()).andDo(print())
    ...
    public void testFindAllByPage() {
        ...
        try {
            ...
            mockMvc.perform(get("/api/books/bypage").param("page", "0").param("size", "2").contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
            /* add a request parameter */
            .content(JsonUtils.convertObjectToJsonBytes(expectedPage))).andExpect(status().isOk()).andDo(print());/*
                                                                                                                  .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))	                
                                                                                                                  .andExpect(jsonPath("$", hasSize(2)))
                                                                                                                  .andExpect(jsonPath("$[0].id", is("1")))
                                                                                                                  .andExpect(jsonPath("$[1].id", is("2")));*/
    ...
    public void testCount() {
        ...
        try {
            ...
            mockMvc.perform(get("/api/books/count")).andExpect(status().isOk()).andDo(print())
                    .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)).andExpect(content().string(count));
            ...
            log.error("", e);
            fail();
>>>>>>> branch 'master' of https://github.com/AVE-cesar/AngularCelerioDemo.git
        }
    }
}
