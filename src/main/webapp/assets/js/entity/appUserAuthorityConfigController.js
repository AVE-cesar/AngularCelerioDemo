...
// Template angular-lab:angularjs/static/assets/js/entity/EntityConfigController.e.vm.js
//

app.controller("AppUserAuthorityConfigController", ["$scope", "$window", "$aside", 
"$log", "AppParameterRestService", 
	...
	log.info("inside AppUserAuthorityConfigController, config.value: " + config.value);
	scope.configValue = angular.fromJson(config.value);

	/** Saves config into database */
	scope.saveConfig = function (configValue) {
		log.info("call method saveConfig inside AppUserAuthorityConfigController");
