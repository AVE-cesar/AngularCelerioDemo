...
app.controller("VbsFlowUnitMediaConfigController", ["$scope", "$window", "$aside", 
"$log", "AppParameterRestService", 
	...
	log.info("inside VbsFlowUnitMediaConfigController, config.value: " + config.value);
	scope.configValue = angular.fromJson(config.value);

	/** Saves config into database */
	scope.saveConfig = function (configValue) {
		log.info("call method saveConfig inside VbsFlowUnitMediaConfigController");
