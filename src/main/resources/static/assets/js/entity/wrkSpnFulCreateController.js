...
app.controller("WrkSpnFulCreateController", ["$scope", "$window", "$aside", 
"$log", "WrkSpnFulRestService", 
	...
	scope.saveItem = function() {
		...
		var onSaveSuccess = function success(data) {
			...
			window.showAlert = function(){
				...
				var userALert = alertService({
		                    title: "SUCCESS:",
		                    content: '<BR>Your wrkSpnFul have been <i>created or updated</i>. You can find it in the result table. See <a href="#"><B>older messages</B></a> !',
		                    placement: "top-right",
		                    type: "theme",
		...
		if (scope.item.id != null) {
			...
			// creation mode
			wrkSpnFulRestService.create(scope.item, onSaveSuccess, onSaveError);
		}
	};
