...
app.controller("CategoryConfigController", ["$scope", "$window", "$aside", 
"$log", "AppParameterRestService", 
	...
	log.info("inside CategoryConfigController, config.value: " + config.value);
	scope.configValue = angular.fromJson(config.value);

	/** Saves config into database */
	scope.saveConfig = function (configValue) {
		log.info("call method saveConfig inside CategoryConfigController");
